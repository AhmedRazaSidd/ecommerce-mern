...
import { ArrowRight, Loader, Lock, LogOut, Mail } from "lucide-react";
        ...
        <div className="bg-gray-800 py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <Mail className="h-5 text-gray-400" aria-hidden="true" />
                </div>
                <input
                  type="email"
                  id="email"
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <Lock className="h-5 text-gray-400" aria-hidden="true" />
                </div>
                <input
                  type="password"
                  id="password"
            ...
            >
              {loading ? (
                ...
                <>
                  <LogOut className="mr-2 h-5 w-5" aria-hidden="true" /> Login
                </>
              )}
            </button>
          </form>
